...
protected:
    ...
    void WriteEventLogEntry(WORD wType, LPCSTR pszFmt, ...);
    void vWriteEventLogEntry(WORD wType, LPCSTR pszFmt, va_list args);
    // Log an error message to the Application event log.
    void WriteErrorLogEntry(LPCSTR pszFunction, DWORD dwError = GetLastError());
